...
local sky, city, cityWindows, alleyway
...
return {
	enter = function(self, from, songNum, songAppend)
		...
		city = graphics.newImage(love.graphics.newImage(graphics.imagePath("week3/phillybuildings")))
		...
		alleyway = graphics.newImage(love.graphics.newImage(graphics.imagePath("week3/alleyway")))
		roads = graphics.newImage(love.graphics.newImage(graphics.imagePath("week3/roads")))

		--behindTrain.y = -100
		--behindTrain.sizeX, behindTrain.sizeY = 1.25, 1.25
		alleyway.y = -100
		alleyway.sizeX, alleyway.sizeY = 1.25, 1.25

		enemy = love.filesystem.load("sprites/week3/Pico.lua")()
	...
	initUI = function(self)
		...
		elseif song == 2 then
			weeks:generateNotes(love.filesystem.load("charts/week3/philly" .. difficulty .. ".lua")())
		else
