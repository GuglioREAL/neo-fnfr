...
return {
	enter = function(self, from, songNum, songAppend)
		...
		images = {
			...
			notesneo = love.graphics.newImage(graphics.imagePath("notesneo")),
		...
		enemy = love.filesystem.load("sprites/week4/mommyMustMurder.lua")()
		boyfriend = love.filesystem.load("sprites/week4/bfCar.lua")()
		rating = love.filesystem.load("sprites/rating.lua")()
		fakeBoyfriend = love.filesystem.load("sprites/bf.lua")() -- Used for game over

		fakeBoyfriend.x, fakeBoyfriend.y = 350, -140
		bgLimo.y = 5
		limoDancer.y = -160
		limoDancer.x = -30
		girlfriend.x, girlfriend.y = 30, -220
		limo.y = 375
		enemy.x, enemy.y = -380, -175
		boyfriend.x, boyfriend.y = 340, -60
