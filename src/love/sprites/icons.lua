...
return graphics.newSprite(
    images.icons,
	{
		...
		{x = 150, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0} -- 24: ParentsDream
	},
	{
		["boyfriend"] = {start = 1, stop = 1, speed = 0, offsetX = 0, offsetY = 0},
		["boyfriend losing"] = {start = 2, stop = 2, speed = 0, offsetX = 0, offsetY = 0},
		["skidmark and poop"] = {start = 3, stop = 3, speed = 0, offsetX = 0, offsetY = 0},
		["skidmark and poop losing"] = {start = 4, stop = 4, speed = 0, offsetX = 0, offsetY = 0},
		...
		["parentsDream"] = {start = 25, stop = 25, speed = 0, offsetX = 0, offsetY = 0}
	},
	"boyfriend",
	false
)
